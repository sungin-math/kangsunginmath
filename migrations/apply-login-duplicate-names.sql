...
-- ────────────────────────────────────────────────────────────
-- 3단계: 배포 후 로그인 확인이 끝나면 실행합니다.  ← 2026-09-04 적용 완료
--
...
--
-- 운영 DB에서는 이미 없어졌습니다. 다시 실행할 필요는 없지만, 해도
-- 아무 일도 일어나지 않습니다.
--
-- 루트 supabase-schema.sql에도 같은 drop만 남기고 생성 구문은 뺐습니다.
-- 예전에는 그 파일이 이 함수를 다시 만들면서 anon 권한까지 줬기 때문에,
-- 새 프로젝트를 만들 때마다 구멍이 되살아났습니다.
--
--
-- 확인용 조회
--
